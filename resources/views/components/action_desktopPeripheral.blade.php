<div x-data="{ open: false }" class="relative inline-block text-left"
    ...
    <div x-show="open"
        ...
        {{-- Updated Edit Button --}}
        <button onclick="document.getElementById('editDeskP').classList.remove('hidden')" class="px-4 py-2 bg-main text-white rounded-lg hover:bg-blue-600">
            Edit
        </button>
    ...
    <div class="bg-white rounded-lg w-full max-w-3xl shadow-lg p-6 relative">
        ...
        <form action="" method="POST" class="space-y-4">
            ...
            <div class="flex justify-end gap-3 mt-4">
                <button type="button"
                    onclick="document.getElementById('editDeskP').classList.add('hidden')"
        ...
        {{-- Close button --}}
        <button onclick="document.getElementById('editDeskP').classList.add('hidden')"
