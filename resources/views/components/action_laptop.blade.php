<div x-data="{ open: false }" class="relative inline-block text-left"
    ...
    <div x-show="open"
         ...
         <button onclick="document.getElementById('editLaptop').classList.remove('hidden')" class="px-4 py-2 bg-main text-white rounded-lg hover:bg-blue-600">
            Edit
        </button>
        <a href="/maintenance/m_laptop" 
...
<div>
            ...
            <div class="flex justify-end gap-3 mt-4">
                <button type="button"
                    onclick="document.getElementById('editLaptop').classList.add('hidden')"
        ...
        {{-- Close button --}}
        <button onclick="document.getElementById('editLaptop').classList.add('hidden')"
